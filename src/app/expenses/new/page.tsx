      ...
      <div className="bg-white/80 backdrop-blur-md rounded-3xl border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 space-y-6 flex-1">
        ...
        <form ref={formRef} action={async (formData) => {
          ...
          <div className="pt-6 border-t border-slate-100 flex justify-end space-x-3">
            ...
            <SubmitButton className="px-5 py-2.5 bg-indigo-600 disabled:opacity-50 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 active:scale-95 transition-all flex items-center justify-center min-w-[120px]">
              申請する
            </SubmitButton>
          </div>
        </form>
